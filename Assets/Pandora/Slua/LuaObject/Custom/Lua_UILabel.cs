...
public class Lua_UILabel : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int UpdateDefaultPrintedSize(IntPtr l) {
		try {
			UILabel self=(UILabel)checkSelf(l);
			self.UpdateDefaultPrintedSize();
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int GetCharacterIndexAtPosition(IntPtr l) {
		try {
			...
			if(matchType(l,argc,2,typeof(UnityEngine.Vector2))){
				...
				checkType(l,2,out a1);
				var ret=self.GetCharacterIndexAtPosition(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int DestroyTureTypeFont(IntPtr l) {
		try {
			UILabel self=(UILabel)checkSelf(l);
			UnityEngine.Font a1;
			checkType(l,2,out a1);
			self.DestroyTureTypeFont(a1);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int DestroyUIFont(IntPtr l) {
		try {
			UILabel self=(UILabel)checkSelf(l);
			UIFont a1;
			checkType(l,2,out a1);
			self.DestroyUIFont(a1);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_fontPath(IntPtr l) {
		try {
			UILabel self=(UILabel)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.fontPath);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_fontPath(IntPtr l) {
		try {
			UILabel self=(UILabel)checkSelf(l);
			System.String v;
			checkType(l,2,out v);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_fontSuffix(IntPtr l) {
		try {
			UILabel self=(UILabel)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.fontSuffix);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_fontSuffix(IntPtr l) {
		try {
			UILabel self=(UILabel)checkSelf(l);
			System.String v;
			checkType(l,2,out v);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,UpdateDefaultPrintedSize);
		...
		addMember(l,SetFont);
		addMember(l,DestroyTureTypeFont);
		addMember(l,DestroyUIFont);
		addMember(l,"keepCrispWhenShrunk",get_keepCrispWhenShrunk,set_keepCrispWhenShrunk,true);
		addMember(l,"fontPath",get_fontPath,set_fontPath,true);
		addMember(l,"fontSuffix",get_fontSuffix,set_fontSuffix,true);
