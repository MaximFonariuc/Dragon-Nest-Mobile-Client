...
public class Lua_UIScrollView : LuaObject {
	...
	static public int NeedRecalcBounds(IntPtr l) {
		try {
			UIScrollView self=(UIScrollView)checkSelf(l);
			self.NeedRecalcBounds();
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int SetAutoMove(IntPtr l) {
		try {
			UIScrollView self=(UIScrollView)checkSelf(l);
			System.Single a1;
			checkType(l,2,out a1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_moveControllerTime(IntPtr l) {
		try {
			UIScrollView self=(UIScrollView)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.moveControllerTime);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_moveControllerTime(IntPtr l) {
		try {
			UIScrollView self=(UIScrollView)checkSelf(l);
			System.Single v;
			checkType(l,2,out v);
			self.moveControllerTime=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"moveControllerTime",get_moveControllerTime,set_moveControllerTime,true);
