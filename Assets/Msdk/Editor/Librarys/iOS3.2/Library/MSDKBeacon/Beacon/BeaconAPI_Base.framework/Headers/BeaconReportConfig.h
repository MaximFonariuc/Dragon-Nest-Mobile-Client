...
typedef NS_ENUM(NSInteger, BeaconCompressionType) {
    BeaconCompressionGZIP = 2,                // GZIP压缩（默认）
    BeaconCompressionLZMA = 4,                // LZMA
};
...
/// 二进制请求包压缩方式，默认GZIP
@property (nonatomic, assign) BeaconCompressionType compressionType;
