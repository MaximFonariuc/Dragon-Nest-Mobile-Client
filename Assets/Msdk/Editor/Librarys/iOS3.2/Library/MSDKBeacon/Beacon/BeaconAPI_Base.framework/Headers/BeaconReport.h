...
#import "BeaconQUICArgs.h"
#import "BeaconMsfSendArgs.h"
#import "BeaconCallBackManager.h"
NS_ASSUME_NONNULL_BEGIN


typedef void (^BeaconQUICCallback)(BeaconQUICArgs *args, BeaconQUICResult *result);
...
@optional
/// QUIC 数据传输的代理接口
- (void)transferArgs:(BeaconQUICArgs *)args
            delegate:(BeaconQUICCallback)callBack;
...
#define BEACON_SDK_VERSION @"4.2.76.43"