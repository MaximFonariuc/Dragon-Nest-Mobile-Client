...
namespace XEditor
{
	...
	public class XResultPanel : XPanel
	{
       ...
       // GUIStyle _myStyle = null;
        //GUIStyle _myStyle2 = null;
        GUIStyle _myLabelStyle2 = null;

        XVector3 _xv = new XVector3(0, 0, 0);

        //private bool _freeze_folded_out = false;
        ...
        protected override void OnInnerGUI()
        {
            ...
            for (int i = 0; i < Hoster.SkillData.Result.Count; i++)
            {
                ...
                EditorGUILayout.Space();
                if (!(Hoster.SkillData.Result[i].LongAttackEffect && Hoster.SkillData.Result[i].LongAttackData.Reinforce))
                {
                ...
                {
                    Hoster.SkillData.Result[i].Loop = false;
                    Hoster.SkillData.Result[i].Group = false;
                }
                EditorGUILayout.Space();
                ...
                if (Hoster.SkillData.Result[i].LongAttackEffect && !Hoster.SkillData.Result[i].Attack_All && !Hoster.SkillData.Result[i].Warning)
                {
                    Hoster.SkillData.Result[i].LongAttackData.Reinforce = EditorGUILayout.Toggle("Reinforce by specific buff", Hoster.SkillData.Result[i].LongAttackData.Reinforce);
                }
                else if (Hoster.SkillData.Result[i].LongAttackData != null)
                    Hoster.SkillData.Result[i].LongAttackData.Reinforce = false;
