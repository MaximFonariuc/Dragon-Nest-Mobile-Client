...
class LevelLayoutManager
{
    ...
    public void OnGUI()
    {
        ...
        // display area
        //scrollPosition = GUILayout.BeginScrollView(scrollPosition, GUILayout.Width(1200), GUILayout.Height(750));
    ...
    public void DrawDetailView()
    {
        if (_levelMgr.CurrentEdit > -1)
        {
            ...
            if (wv != null)
            {
                ...
                //GUILayout.BeginVertical(new GUILayoutOption[] {GUILayout.ExpandWidth(true), GUILayout.Height(130) });
                GUILayout.BeginVertical();
                    ...
                    GUILayout.Space(20);
                    //GUILayout.BeginHorizontal();
                    //wv._loopInterval = EditorGUILayout.IntSlider("Loop(second):", wv._loopInterval, 0, 60);
                    //GUILayout.EndHorizontal();
        ...
        if (_levelMgr.CurrentEdit > -1)
        {
            ...
            if (_wave._preWaves != null && _wave._preWaves.Length > 0)
            {
                ...
                for (int i = 0; i < strPreWaves.Length; i++)
                {
                    ...
                    if (b)
                    {
                        curveFromTo(preWaveId, _wave._id, Color.green, Color.yellow);
                    }
                }
            }
