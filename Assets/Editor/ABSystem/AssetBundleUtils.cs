...
namespace ABSystem
{
    ...
    class AssetBundleUtils
    {
        ...
        public static void LoadCache()
        {
            ...
            switch (EditorUserBuildSettings.activeBuildTarget)
            {
                case BuildTarget.Android:
                    cacheTxtFilePath = pathResolver.AndroidHashCacheSaveFile;
                    break;
                case BuildTarget.iOS:
                    cacheTxtFilePath = pathResolver.iOSHashCacheSaveFile;
                    break;
                default:
                    cacheTxtFilePath = pathResolver.DefaultHashCacheSaveFile;
                    break;
            }
        ...
        public static void SaveCache()
        {
            ...
            {
                case BuildTarget.Android:
                    sw = new StreamWriter(pathResolver.AndroidHashCacheSaveFile);
                    break;
                case BuildTarget.iOS:
                    sw = new StreamWriter(pathResolver.iOSHashCacheSaveFile);
                    break;
                default:
                    sw = new StreamWriter(pathResolver.DefaultHashCacheSaveFile);
                    break;
            }
