...
PACK_PATH=/Users/liming/Desktop/DN/dragon-nest/XProject/IOS/DragonNest_test
IPA_NAME=DragonNest
...
$UNITY_PATH -projectPath $PROJECT_PATH -executeMethod SelectPlatformEditor.BuildiOSTest -quit -batchmode
...
xcodebuild -exportArchive -archivePath Unity-iPhone.xcarchive -exportPath ${PACK_PATH}/longzhigu_ios_test_${VERSION}.ipa -exportFormat ipa CODE_SIGN_IDENTITY=$CODE_SIGN_IDENTITY -exportProvisioningProfile "$PROVISIONING_PROFILE_NAME"
...
sed 's/@version@/test_${VERSION}/g' /Users/liming/longzhigu_ios_version.plist > ${PACK_PATH}/longzhigu_ios_test_${VERSION}.plist
...
cd longzhigu
prompt
mput longzhigu_ios_test_${VERSION}.ipa
mput longzhigu_ios_test_${VERSION}.plist
bye
END
