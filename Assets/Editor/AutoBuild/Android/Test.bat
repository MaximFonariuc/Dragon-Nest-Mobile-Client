...
"%UNITY_PATH%" -projectPath "%PROJECT_PATH%" -executeMethod SelectPlatformEditor.BuildAndroidTest -quit
...
mv %PROJECT_PATH%\Android\DragonNest.apk %PROJECT_PATH%\Android\longzhigu_android_test_%VERSION%.apk
