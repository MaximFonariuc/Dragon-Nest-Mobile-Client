...
namespace XEditor
{
	public class XPlayerClip : XClip
	{
        ...
        private AnimationClip _clip7 = null;
        ...
        protected override void OnInnerGUI(XCutSceneData data)
        {
            ...
            _clip7 = EditorGUILayout.ObjectField("Kali Animation", _clip7, typeof(AnimationClip), true) as AnimationClip;
        ...
        public override void Flush()
        {
            ...
            _clip7 = Resources.Load(_data.Clip7, typeof(AnimationClip)) as AnimationClip;
        }
