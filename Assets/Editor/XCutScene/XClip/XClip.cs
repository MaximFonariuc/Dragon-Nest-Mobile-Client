...
namespace XEditor
{
    public class XClipComparer : IComparer<XClip>
    {
        public int Compare(XClip x, XClip y)
        {
            ...
            if (x.TimeLine < y.TimeLine) return -1;
            else if (x.TimeLine > y.TimeLine) return 1;
            else
            {
                int r = x.ClipType - y.ClipType;
                if (r == 0) r = -1;
	...
	public abstract class XClip
	{
        ...
        public string Title
        {
            get
            {
                return "(Timeline " + CutSceneClip.TimeLineAt.ToString("F1") + "fm/" + (CutSceneClip.TimeLineAt * (1 / 30.0f)).ToString("F2") + "s) " + CutSceneClip.Type.ToString() + ": " + Name;
            }
        }
        ...
        public static string LocateRes(UnityEngine.Object o)
        {
