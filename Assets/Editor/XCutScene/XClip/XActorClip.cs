	...
	public class XActorClip : XClip
	{
        ...
        protected override void OnInnerGUI(XCutSceneData data)
        {
            ...
            else
            {
                ...
                _prefab = XStatisticsLibrary.GetDummy((uint)_id);
                if (_prefab != null)
                {
            ...
            if (!XInnerEditor.CheckPrefab(_prefab)) _prefab = null;
        ...
        {
            _prefab = _data.bUsingID ? XStatisticsLibrary.GetDummy((uint)_data.StatisticsID) : Resources.Load(_data.Prefab) as GameObject;
