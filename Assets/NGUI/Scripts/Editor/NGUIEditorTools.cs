...
public class NGUIEditorTools
{
	...
	static public bool MakeTextureReadable (string path, bool force)
	{
        ...
        UnityEditor.TextureImporterPlatformSettings tips = ti.GetPlatformTextureSettings(BuildTarget.StandaloneWindows.ToString());
			...
			)
		{
            ...
            tips.format = TextureImporterFormat.ARGB32;
