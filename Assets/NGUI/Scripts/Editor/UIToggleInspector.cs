...
public class UIToggleInspector : UIWidgetContainerEditor
{
	...
	public override void OnInspectorGUI ()
	{
        ...
        NGUIEditorTools.DrawProperty("OptionCanBeNone", serializedObject, "optionCanBeNone", GUILayout.Width(200f));
		...
		if (NGUIEditorTools.DrawHeader("State Transition"))
		{
            ...
            NGUIEditorTools.DrawProperty("Sprite2", serializedObject, "activeSprite2");
