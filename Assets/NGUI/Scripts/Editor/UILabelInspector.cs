...
public class UILabelInspector : UIWidgetInspector
{
	...
	protected override bool ShouldDrawProperties ()
	{
		...
		EditorGUI.BeginDisabledGroup(!isValid);
		{
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label("EffectLock", GUILayout.Width(76f));
            SerializedProperty  el = NGUIEditorTools.DrawProperty("", serializedObject, "mOutLineLock", GUILayout.MinWidth(16f));
            GUILayout.Label("When the choice to add special effects");
            GUILayout.EndHorizontal();
            EditorGUI.BeginDisabledGroup(!el.hasMultipleDifferentValues && !el.boolValue);
            {
