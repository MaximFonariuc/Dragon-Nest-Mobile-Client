...
public class UISpriteInspector : UIWidgetInspector
{
	...
	protected override void DrawCustomProperties ()
	{
		...
		EditorGUI.BeginDisabledGroup(sp.hasMultipleDifferentValues);
		{
			...
			{
				NGUIEditorTools.DrawProperty("Flip", serializedObject, "mFlip");
				SerializedProperty dirSp = NGUIEditorTools.DrawProperty("Fill Dir", serializedObject, "mFillDirection", GUILayout.MinWidth(20f));
				GUILayout.BeginHorizontal();
				GUILayout.Space(4f);
                ...
                UISprite.FillDirection dir = (UISprite.FillDirection)dirSp.intValue;
                if (dir == UISprite.FillDirection.Radial360)
                {
                    GUILayout.BeginHorizontal();
                    GUILayout.Space(4f);
                    NGUIEditorTools.DrawProperty("Fill Scale", serializedObject, "mFillScale", GUILayout.MinWidth(20f));
                    GUILayout.Space(4f);
                    GUILayout.EndHorizontal();
                }
