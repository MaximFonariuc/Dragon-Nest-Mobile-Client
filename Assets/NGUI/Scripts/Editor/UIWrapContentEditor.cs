...
public class UIWrapContentEditor : Editor
{
	public override void OnInspectorGUI ()
	{
		...
		NGUIEditorTools.DrawProperty(fieldName, serializedObject, "itemSize", GUILayout.Width(300f));
		GUILayout.EndHorizontal();
		NGUIEditorTools.DrawProperty("Cull Content", serializedObject, "cullContent");
        NGUIEditorTools.DrawProperty("NoneScroll Dimension", serializedObject, "WidthDimension", GUILayout.Width(230f));
        NGUIEditorTools.DrawProperty("Scroll Dimension Max", serializedObject, "HeightDimemsionMax", GUILayout.Width(230f));
        NGUIEditorTools.DrawProperty("Has Bounds", serializedObject, "bBounds");
