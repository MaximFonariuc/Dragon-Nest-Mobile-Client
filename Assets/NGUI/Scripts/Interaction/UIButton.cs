...
public class UIButton : UIButtonColor
{
	...
	public override bool isEnabled
	{
		get
		{
            ...
            if (cacheCol && cacheCol.enabled) return true;
#if !UNITY_3_5 && !UNITY_4_0 && !UNITY_4_1 && !UNITY_4_2
			//Collider2D c2d = GetComponent<Collider2D>();
			return (cacheC2d && cacheC2d.enabled);
#else
			return false;
#endif
		}
...
//#if UNITY_EDITOR
        ...
        if (cacheC2d == null)
            cacheC2d = GetComponent<Collider2D>();
//#endif       
	...
	public override void SetState (State state, bool immediate)
	{
		...
		switch (state)
		{
            ...
            case State.Hover: if (changeStateSprite) SetSprite(hoverSprite); break;
            case State.Pressed: if (changeStateSprite) SetSprite(pressedSprite); break;
