...
#region Common functionality
	...
	void OnDragStart ()
	{
		...
		if (cloneOnDrag)
		{
            ...
            // hack, i don't know why data lost after instantce
		    {
		        XUIDragDropItem src = gameObject.GetComponent("XUIDragDropItem") as XUIDragDropItem;
		        XUIDragDropItem dst = clone.GetComponent("XUIDragDropItem") as XUIDragDropItem;

		        if (src != null && dst != null)
		        {
                    dst.m_OnFinishHandler = src.m_OnFinishHandler;
		            dst.m_OnStartHandler = src.m_OnStartHandler;
		        }
		
		        XUISprite srcSP = gameObject.GetComponent("XUISprite") as XUISprite;
		        XUISprite dstSP = clone.GetComponent("XUISprite") as XUISprite;

		        if (srcSP != null && dstSP != null)
		            dstSP.ID = srcSP.ID;

                UIWidget[] allWidget = clone.GetComponentsInChildren<UIWidget>();
