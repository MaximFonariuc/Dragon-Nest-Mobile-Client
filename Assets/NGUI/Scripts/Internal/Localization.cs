...
public static class Localization
{
	...
	static bool LoadDictionary (string value)
	{
        ...
        TextAsset txt = localizationHasBeenSet ? null : Resources.Load("Table/Local/Localization", typeof(TextAsset)) as TextAsset;
...
//#endif
        if (HotfixManager.Instance.hotmsglist.TryGetValue(key, out val)) return val;
