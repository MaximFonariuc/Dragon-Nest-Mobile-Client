...
public class UIInput : MonoBehaviour
{
	...
	protected void OnDeselectEvent ()
	{
		...
		if (label != null && NGUITools.GetActive(this))
		{
			...
			{
                label.text = Localization.Get(mDefaultText);
	...
	public void UpdateLabel ()
	{
		if (label != null)
		{
			...
			if (isEmpty)
			{
				processed = selected ? "" : Localization.Get(mDefaultText);
				RestoreLabelPivot();
			}
			else
			{
			...
			if (selected)
			{
				...
				if (start != end)
				{
					if (mHighlight == null)
					{
						...
						mHighlight.SetRuntimeTexture(mBlankTex);
				...
				if (mCaret == null)
				{
                    ...
                    mCaret.SetRuntimeTexture(mBlankTex);
