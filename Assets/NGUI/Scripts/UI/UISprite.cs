...
{
    static public UISprite current;
	...
	[Range(0f, 1f)]
#endif
    [HideInInspector][SerializeField] float mFillScale = 1.0f;
        ...
        }
        {
			if (mFillDirection == FillDirection.Radial360)
			{
				for (int corner = 0; corner < 4; ++corner)
				{
					...
					float val = mInvert ?
                        mFillAmount * 4f * mFillScale - NGUIMath.RepeatIndex(corner + 2, 4) :
						mFillAmount * 4f * mFillScale - (3 - NGUIMath.RepeatIndex(corner + 2, 4));
