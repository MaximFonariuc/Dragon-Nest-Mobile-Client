...
public partial class TableView : IDisposable 
{
    ...
    public void RefreshData(List<object> entries,int sortSlot = 0, Dictionary<object, Color> specialTextColors = null)
    {
        m_lines = entries;
        _sortSlot = sortSlot;
    ...
    public void Draw(Rect area)
    {
        ...
        //Debug.LogFormat("scroll pos: {0:0.00}, {1:0.00}", _scrollPos.x, _scrollPos.y);
        {
            ...
            s.fixedHeight = m_lines != null ? _appearance.LineHeight * m_lines.Count : 0;
            s.stretchWidth = true;
            Rect r = EditorGUILayout.BeginVertical(s);
            {
                ...
                int lastLine = Mathf.Min(firstLine + shownLineCount, m_lines != null ? m_lines.Count : 0);
